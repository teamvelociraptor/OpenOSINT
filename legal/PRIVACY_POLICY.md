> **Not legal advice.** Starting-point template for OpenOSINT Cloud. You are in the EU, so the GDPR applies: review carefully with a lawyer or DPO before relying on this document.
...
## 3. Data about third parties in queries
